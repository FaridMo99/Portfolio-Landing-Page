...
const projects: Projects[] = [
...

  {
    ...
    technologies: ["NextJs", "OpenAI API", "Typescript", "React", "TailwindCSS", "ShadCN"],
  ...
  },
  {
    ...
    For better Performance this application makes heavy use of Goroutines and concurrency Patterns which Go is known for.`,
    image: wiseLogoPaths[2],
    githubLink: "https://github.com/FaridMo99/wise",
    technologies: ["Go", "Cobra", "Goroutines", "Concurrency"],
